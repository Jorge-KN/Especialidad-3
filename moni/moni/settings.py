...
DATABASES = {
    "default": {
        ...
        "NAME": "aquacircuitdb",  # Nombre de la base de datos
        "USER": "adminuser",  # Usuario de la base de datos
        "PASSWORD": "Vertientes1",  # Contraseña de la base de datos
        "HOST": "vertientes-db-server.postgres.database.azure.com",  # Host de la base de datos
